...
<!-- Animated skill bar -->
<script src="{{ asset('plugins/bower_components/AnimatedSkillsDiagram/js/animated-bar.js')}}"></script>
<!-- chartist chart -->
<script src="{{ asset('plugins/bower_components/chartist-js/dist/chartist.min.js')}}"></script>
<script src="{{ asset('plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js')}}"></script>
<!-- Guage chart -->
<script src="{{ asset('plugins/bower_components/Minimal-Gauge-chart/js/cmGauge.js')}}"></script>
